...
type Client interface {
	...
	WriteData(writeRequest *protocol.WriteDataRequest, topic string,
	...
	ImportData(importRequest *protocol.ImportDataRequest, topic string,
	...
	Done(request *protocol.DoneRequest, topic string, opts ...option.Option) (*protocol.DoneResponse, error)
	...
	Predict(request *protocol.PredictRequest, modelId string, opts ...option.Option) (*protocol.PredictResponse, error)
	...
	// ].
	AckServerImpressions(request *protocol.AckServerImpressionsRequest, modelId string,
