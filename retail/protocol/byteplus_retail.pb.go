...
type ListOperationsRequest struct {
	...
	// Optional, default 20
	// The standard list page size. max to
...
type User struct {
	...
	// Optional.
	// This field is used to pack key-value pairs.
	// See [this](../docs/effective-and-efficient-data-synchronization#handling-extra-data) for more details.
...
type WriteUsersRequest struct {
	...
	// The max number of users allowed is 100, otherwise a standard 400 error is
	// returned.
...
func (x *WriteUsersResponse) GetStatus() *Status {
	if x != nil {
		return x.Status
	}
	return nil
...
type UsersInlineSource struct {
	...
	// Optional.
	// A list of users to import. The max number of items supported is 10k.
	Users []*User `protobuf:"bytes,1,rep,name=users,proto3" json:"users,omitempty"`
}
...
func (x *ImportUsersResponse) GetStatus() *Status {
	if x != nil {
		return x.Status
	}
	return nil
...
type Product struct {
	...
	// Please be aware of the accuracy and recency.
	// Please refer to
	// [this](../docs/ways-to-improve-recommendation-performance#data-recency) for more details.
	...
	// Required.
	// The product title. Callers can use the text name of the product here, or
	// the title in the HTML page.
	Title string `protobuf:"bytes,6,opt,name=title,proto3" json:"title,omitempty"`
	// Optional.
	// The product quality score given by the seller.
...
// The response for the `WriteProducts` call.
...
func (x *WriteProductsResponse) GetStatus() *Status {
	if x != nil {
		return x.Status
	}
	return nil
...
type ProductsInlineSource struct {
	...
	// The max number of items allowed is 10k.
	Products []*Product `protobuf:"bytes,1,rep,name=products,proto3" json:"products,omitempty"`
}
...
func (x *ImportProductsResponse) GetStatus() *Status {
	if x != nil {
		return x.Status
	}
	return nil
...
// Request proto for `WriteUserEvent` call.
type WriteUserEventsRequest struct {
	...
	// The max number of events allowed is 100.
...
// The error details for a single user event.
...
func (x *WriteUserEventsResponse) GetStatus() *Status {
	if x != nil {
		return x.Status
	}
	return nil
...
// The inline source for the input config for `ImportUserEvents` call.
...
// Request proto for the `ImportUserEvents` call.
...
func (*ImportUserEventsRequest) Descriptor() ([]byte, []int) {
	return file_byteplus_retail_proto_rawDescGZIP(), []int{31}
}
...
func (x *ImportUserEventsResponse) Reset() {
	*x = ImportUserEventsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_byteplus_retail_proto_msgTypes[32]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ImportUserEventsResponse) Descriptor() ([]byte, []int) {
	return file_byteplus_retail_proto_rawDescGZIP(), []int{32}
}

func (x *ImportUserEventsResponse) GetStatus() *Status {
	if x != nil {
		return x.Status
	}
	return nil
...
type PredictRequest struct {
	...
	// The actual number of products returned is the min of:
	// `size`
	// length(`context.candidates_product_ids`)
	// total number of products with `is_recommendable=True`
...
func (x *PredictRequest) Reset() {
	*x = PredictRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_byteplus_retail_proto_msgTypes[33]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PredictRequest) Descriptor() ([]byte, []int) {
	return file_byteplus_retail_proto_rawDescGZIP(), []int{33}
}
...
type PredictResult struct {
	...
	// Output only.
	// This field is used to provide customized info only.
	// Please talk to BytePlus Recommend team first before using it.
	Extra map[string]string `protobuf:"bytes,100,rep,name=extra,proto3" json:"extra,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *PredictResult) Reset() {
	*x = PredictResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_byteplus_retail_proto_msgTypes[34]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PredictResult) Descriptor() ([]byte, []int) {
	return file_byteplus_retail_proto_rawDescGZIP(), []int{34}
}
...
func (*PredictResponse) Descriptor() ([]byte, []int) {
	return file_byteplus_retail_proto_rawDescGZIP(), []int{35}
}
...
func (*AckServerImpressionsRequest) Descriptor() ([]byte, []int) {
	return file_byteplus_retail_proto_rawDescGZIP(), []int{36}
}
...
func (*AckServerImpressionsResponse) Descriptor() ([]byte, []int) {
	return file_byteplus_retail_proto_rawDescGZIP(), []int{37}
}
...
func (*User_Location) Descriptor() ([]byte, []int) {
	return file_byteplus_retail_proto_rawDescGZIP(), []int{7, 0}
}
...
func (*Product_Category) Descriptor() ([]byte, []int) {
	return file_byteplus_retail_proto_rawDescGZIP(), []int{17, 0}
}
...
func (x *Product_Brand) Reset() {
	*x = Product_Brand{}
	if protoimpl.UnsafeEnabled {
		mi := &file_byteplus_retail_proto_msgTypes[43]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Product_Brand) Descriptor() ([]byte, []int) {
	return file_byteplus_retail_proto_rawDescGZIP(), []int{17, 1}
}
...
func (x *Product_Price) Reset() {
	*x = Product_Price{}
	if protoimpl.UnsafeEnabled {
		mi := &file_byteplus_retail_proto_msgTypes[44]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Product_Price) Descriptor() ([]byte, []int) {
	return file_byteplus_retail_proto_rawDescGZIP(), []int{17, 2}
}
...
type Product_Display struct {
	...
	// put the url to the media file here.
...
func (*Product_Display) Descriptor() ([]byte, []int) {
	return file_byteplus_retail_proto_rawDescGZIP(), []int{17, 3}
}
...
type Product_ProductSpec struct {
	...
	// Optional.
	// The number of comments for this product.
...
func (*Product_ProductSpec) Descriptor() ([]byte, []int) {
	return file_byteplus_retail_proto_rawDescGZIP(), []int{17, 4}
}
...
type Product_Seller struct {
	...
	// Optional.
	// The seller's rating given by the customers.
...
func (*Product_Seller) Descriptor() ([]byte, []int) {
	return file_byteplus_retail_proto_rawDescGZIP(), []int{17, 5}
}
...
func (x *Product_Category_CategoryNode) Reset() {
	*x = Product_Category_CategoryNode{}
	if protoimpl.UnsafeEnabled {
		mi := &file_byteplus_retail_proto_msgTypes[49]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Product_Category_CategoryNode) Descriptor() ([]byte, []int) {
	return file_byteplus_retail_proto_rawDescGZIP(), []int{17, 0, 0}
}
...
func (x *UserEvent_Scene) Reset() {
	*x = UserEvent_Scene{}
	if protoimpl.UnsafeEnabled {
		mi := &file_byteplus_retail_proto_msgTypes[52]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UserEvent_Scene) Descriptor() ([]byte, []int) {
	return file_byteplus_retail_proto_rawDescGZIP(), []int{25, 0}
}
...
type UserEvent_Device struct {
	...
	// app: user uses mobile via mobile app.
	// desktop-web: user uses desktop via web browser.
	// mobile-web: user uses mobile via web browser.
...
func (*UserEvent_Device) Descriptor() ([]byte, []int) {
	return file_byteplus_retail_proto_rawDescGZIP(), []int{25, 1}
}
...
func (x *UserEvent_Context) Reset() {
	*x = UserEvent_Context{}
	if protoimpl.UnsafeEnabled {
		mi := &file_byteplus_retail_proto_msgTypes[54]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UserEvent_Context) Descriptor() ([]byte, []int) {
	return file_byteplus_retail_proto_rawDescGZIP(), []int{25, 2}
}
...
func (x *PredictRequest_Context) Reset() {
	*x = PredictRequest_Context{}
	if protoimpl.UnsafeEnabled {
		mi := &file_byteplus_retail_proto_msgTypes[58]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PredictRequest_Context) Descriptor() ([]byte, []int) {
	return file_byteplus_retail_proto_rawDescGZIP(), []int{33, 0}
}
...
func (x *PredictResult_ResponseProduct) Reset() {
	*x = PredictResult_ResponseProduct{}
	if protoimpl.UnsafeEnabled {
		mi := &file_byteplus_retail_proto_msgTypes[60]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PredictResult_ResponseProduct) Descriptor() ([]byte, []int) {
	return file_byteplus_retail_proto_rawDescGZIP(), []int{34, 0}
}
...
func (x *AckServerImpressionsRequest_AlteredProduct) Reset() {
	*x = AckServerImpressionsRequest_AlteredProduct{}
	if protoimpl.UnsafeEnabled {
		mi := &file_byteplus_retail_proto_msgTypes[63]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AckServerImpressionsRequest_AlteredProduct) Descriptor() ([]byte, []int) {
	return file_byteplus_retail_proto_rawDescGZIP(), []int{36, 0}
}
...
var file_byteplus_retail_proto_rawDesc = []byte{
	...
	0x69, 0x6c, 0x1a, 0x19, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	...
	,
	...
	0x79, 0x74, 0x65, 0x70, 0x6c, 0x75, 0x73, 0x2e, 0x72, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x2e, 0x53,
	...
	0x65, 0x70, 0x6c, 0x75, 0x73, 0x2e, 0x72, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x2e, 0x4f, 0x70, 0x65,
	0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x09, 0x6f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x22, 0x29, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x4f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f,
	...
	0x70, 0x61, 0x67, 0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0xc1, 0x01, 0x0a, 0x16, 0x4c, 0x69,
	...
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x21, 0x2e, 0x62, 0x79, 0x74, 0x65, 0x64, 0x61, 0x6e, 0x63, 0x65,
	...
	0x03, 0x28, 0x0b, 0x32, 0x24, 0x2e, 0x62, 0x79, 0x74, 0x65, 0x64, 0x61, 0x6e, 0x63, 0x65, 0x2e,
	...
	0x6e, 0x65, 0x78, 0x74, 0x50, 0x61, 0x67, 0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0xb0, 0x04,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x61, 0x67, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x74, 0x61, 0x67,
	...
	0x6e, 0x65, 0x6c, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x11, 0x61, 0x63, 0x74, 0x69, 0x76,
	...
	0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0f, 0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x73, 0x68,
	...
	0x70, 0x18, 0x07, 0x20, 0x01, 0x28, 0x03, 0x52, 0x15, 0x72, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x12, 0x40, 0x0a, 0x05, 0x65, 0x78, 0x74, 0x72, 0x61, 0x18, 0x64, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x2a, 0x2e, 0x62, 0x79, 0x74, 0x65, 0x64, 0x61, 0x6e, 0x63, 0x65, 0x2e,
	0x62, 0x79, 0x74, 0x65, 0x70, 0x6c, 0x75, 0x73, 0x2e, 0x72, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x2e,
	0x55, 0x73, 0x65, 0x72, 0x2e, 0x45, 0x78, 0x74, 0x72, 0x61, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52,
	0x05, 0x65, 0x78, 0x74, 0x72, 0x61, 0x1a, 0x7e, 0x0a, 0x08, 0x4c, 0x6f, 0x63, 0x61, 0x74, 0x69,
	...
	,
	...
	0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x5a, 0x0a, 0x09, 0x55, 0x73, 0x65, 0x72, 0x45, 0x72,
	...
	0x04, 0x75, 0x73, 0x65, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x62, 0x79,
	0x74, 0x65, 0x64, 0x61, 0x6e, 0x63, 0x65, 0x2e, 0x62, 0x79, 0x74, 0x65, 0x70, 0x6c, 0x75, 0x73,
	0x2e, 0x72, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x04, 0x75, 0x73,
	0x65, 0x72, 0x22, 0x8d, 0x01, 0x0a, 0x12, 0x57, 0x72, 0x69, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72,
	0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x39, 0x0a, 0x06, 0x73, 0x74, 0x61,
	0x74, 0x75, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x21, 0x2e, 0x62, 0x79, 0x74, 0x65,
	...
	,
	...
	,
	...
	,
	...
	0x6c, 0x75, 0x73, 0x2e, 0x72, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x75,
	0x73, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x49, 0x0a, 0x0d, 0x65, 0x72, 0x72,
	0x6f, 0x72, 0x5f, 0x73, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b,
	0x32, 0x24, 0x2e, 0x62, 0x79, 0x74, 0x65, 0x64, 0x61, 0x6e, 0x63, 0x65, 0x2e, 0x62, 0x79, 0x74,
	0x65, 0x70, 0x6c, 0x75, 0x73, 0x2e, 0x72, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x2e, 0x55, 0x73, 0x65,
	0x72, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x52, 0x0c, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x53, 0x61, 0x6d,
	0x70, 0x6c, 0x65, 0x73, 0x22, 0xbc, 0x0c, 0x0a, 0x07, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74,
	...
	,
	...
	0x74, 0x2e, 0x50, 0x72, 0x69, 0x63, 0x65, 0x52, 0x05, 0x70, 0x72, 0x69, 0x63, 0x65, 0x12, 0x29,
	0x0a, 0x10, 0x69, 0x73, 0x5f, 0x72, 0x65, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x64, 0x61, 0x62,
	0x6c, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0f, 0x69, 0x73, 0x52, 0x65, 0x63, 0x6f,
	0x6d, 0x6d, 0x65, 0x6e, 0x64, 0x61, 0x62, 0x6c, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x69, 0x74,
	...
	0x18, 0x07, 0x20, 0x01, 0x28, 0x01, 0x52, 0x0c, 0x71, 0x75, 0x61, 0x6c, 0x69, 0x74, 0x79, 0x53,
	0x63, 0x6f, 0x72, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x74, 0x61, 0x67, 0x73, 0x18, 0x08, 0x20, 0x03,
	0x28, 0x09, 0x52, 0x04, 0x74, 0x61, 0x67, 0x73, 0x12, 0x44, 0x0a, 0x07, 0x64, 0x69, 0x73, 0x70,
	0x6c, 0x61, 0x79, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2a, 0x2e, 0x62, 0x79, 0x74, 0x65,
	0x64, 0x61, 0x6e, 0x63, 0x65, 0x2e, 0x62, 0x79, 0x74, 0x65, 0x70, 0x6c, 0x75, 0x73, 0x2e, 0x72,
	0x65, 0x74, 0x61, 0x69, 0x6c, 0x2e, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x2e, 0x44, 0x69,
	0x73, 0x70, 0x6c, 0x61, 0x79, 0x52, 0x07, 0x64, 0x69, 0x73, 0x70, 0x6c, 0x61, 0x79, 0x12, 0x51,
	...
	0x53, 0x70, 0x65, 0x63, 0x52, 0x0b, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x53, 0x70, 0x65,
	0x63, 0x12, 0x41, 0x0a, 0x06, 0x73, 0x65, 0x6c, 0x6c, 0x65, 0x72, 0x18, 0x0b, 0x20, 0x01, 0x28,
	...
	,
	...
	,
	...
	0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x66, 0x0a, 0x0c, 0x50, 0x72, 0x6f, 0x64,
	0x75, 0x63, 0x74, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x12, 0x18, 0x0a, 0x07, 0x6d, 0x65, 0x73, 0x73,
	0x61, 0x67, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61,
	0x67, 0x65, 0x12, 0x3c, 0x0a, 0x07, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x18, 0x02, 0x20,
	...
	0x22, 0x93, 0x01, 0x0a, 0x15, 0x57, 0x72, 0x69, 0x74, 0x65, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63,
	...
	,
	...
	,
	...
	0x65, 0x76, 0x65, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65, 0x12, 0x27, 0x0a, 0x0f, 0x65, 0x76, 0x65,
	...
	,
	...
	,
	...
	0x74, 0x1a, 0x9f, 0x02, 0x0a, 0x06, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x12, 0x1a, 0x0a, 0x08,
	...
	,
	...
	0x2e, 0x62, 0x79, 0x74, 0x65, 0x64, 0x61, 0x6e, 0x63, 0x65, 0x2e, 0x62, 0x79, 0x74, 0x65, 0x70,
	0x6c, 0x75, 0x73, 0x2e, 0x72, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x45,
	0x76, 0x65, 0x6e, 0x74, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x52, 0x06, 0x65, 0x72, 0x72, 0x6f, 0x72,
	0x73, 0x22, 0x5f, 0x0a, 0x16, 0x55, 0x73, 0x65, 0x72, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x49,
	0x6e, 0x6c, 0x69, 0x6e, 0x65, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x12, 0x45, 0x0a, 0x0b, 0x75,
	...
	,
	...
	0x38, 0x01, 0x22, 0xa5, 0x01, 0x0a, 0x18, 0x49, 0x6d, 0x70, 0x6f, 0x72, 0x74, 0x55, 0x73, 0x65,
	...
	0x70, 0x6c, 0x75, 0x73, 0x2e, 0x72, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x2e, 0x53, 0x74, 0x61, 0x74,
	0x75, 0x73, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x4e, 0x0a, 0x0d, 0x65, 0x72,
	0x72, 0x6f, 0x72, 0x5f, 0x73, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x29, 0x2e, 0x62, 0x79, 0x74, 0x65, 0x64, 0x61, 0x6e, 0x63, 0x65, 0x2e, 0x62, 0x79,
	0x74, 0x65, 0x70, 0x6c, 0x75, 0x73, 0x2e, 0x72, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x2e, 0x55, 0x73,
	0x65, 0x72, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x52, 0x0c, 0x65, 0x72,
	0x72, 0x6f, 0x72, 0x53, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x73, 0x22, 0x9e, 0x04, 0x0a, 0x0e, 0x50,
	...
	,
	...
	0x9c, 0x02, 0x0a, 0x0f, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x50, 0x72, 0x6f, 0x64,
	...
	0x52, 0x07, 0x72, 0x65, 0x63, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x59, 0x0a, 0x05, 0x65, 0x78, 0x74,
	0x72, 0x61, 0x18, 0x64, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x43, 0x2e, 0x62, 0x79, 0x74, 0x65, 0x64,
	0x61, 0x6e, 0x63, 0x65, 0x2e, 0x62, 0x79, 0x74, 0x65, 0x70, 0x6c, 0x75, 0x73, 0x2e, 0x72, 0x65,
	0x74, 0x61, 0x69, 0x6c, 0x2e, 0x50, 0x72, 0x65, 0x64, 0x69, 0x63, 0x74, 0x52, 0x65, 0x73, 0x75,
	0x6c, 0x74, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x50, 0x72, 0x6f, 0x64, 0x75,
	...
	0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x14,
	0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x76,
	0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xab, 0x01, 0x0a, 0x0f, 0x50, 0x72, 0x65,
	...
	0x79, 0x74, 0x65, 0x64, 0x61, 0x6e, 0x63, 0x65, 0x2e, 0x62, 0x79, 0x74, 0x65, 0x70, 0x6c, 0x75,
	0x73, 0x2e, 0x72, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52,
	...
	,
	...
	0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x74, 0x72, 0x61, 0x66, 0x66, 0x69, 0x63, 0x53, 0x6f,
	0x75, 0x72, 0x63, 0x65, 0x12, 0x40, 0x0a, 0x05, 0x73, 0x63, 0x65, 0x6e, 0x65, 0x18, 0x04, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x2a, 0x2e, 0x62, 0x79, 0x74, 0x65, 0x64, 0x61, 0x6e, 0x63, 0x65, 0x2e,
	0x62, 0x79, 0x74, 0x65, 0x70, 0x6c, 0x75, 0x73, 0x2e, 0x72, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x2e,
	0x55, 0x73, 0x65, 0x72, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x2e, 0x53, 0x63, 0x65, 0x6e, 0x65, 0x52,
	0x05, 0x73, 0x63, 0x65, 0x6e, 0x65, 0x12, 0x70, 0x0a, 0x10, 0x61, 0x6c, 0x74, 0x65, 0x72, 0x65,
	...
	,
	...
	,
	...
	,
	...
	0x74, 0x65, 0x70, 0x6c, 0x75, 0x73, 0x2e, 0x72, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x2e, 0x50, 0x72,
	0x65, 0x64, 0x69, 0x63, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x87, 0x01,
	0x0a, 0x14, 0x41, 0x63, 0x6b, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x49, 0x6d, 0x70, 0x72, 0x65,
	0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x36, 0x2e, 0x62, 0x79, 0x74, 0x65, 0x64, 0x61, 0x6e,
	0x63, 0x65, 0x2e, 0x62, 0x79, 0x74, 0x65, 0x70, 0x6c, 0x75, 0x73, 0x2e, 0x72, 0x65, 0x74, 0x61,
	...
	0x2e, 0x62, 0x79, 0x74, 0x65, 0x64, 0x61, 0x6e, 0x63, 0x65, 0x2e, 0x62, 0x79, 0x74, 0x65, 0x70,
	0x6c, 0x75, 0x73, 0x2e, 0x72, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x2e, 0x41, 0x63, 0x6b, 0x53, 0x65,
	0x72, 0x76, 0x65, 0x72, 0x49, 0x6d, 0x70, 0x72, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x2d, 0x5a, 0x2b, 0x67, 0x69, 0x74, 0x68, 0x75,
	0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x62, 0x79, 0x74, 0x65, 0x2d, 0x70, 0x6c, 0x75, 0x73, 0x2f,
	0x73, 0x64, 0x6b, 0x2d, 0x67, 0x6f, 0x2f, 0x72, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x2f, 0x70, 0x72,
...
var file_byteplus_retail_proto_msgTypes = make([]protoimpl.MessageInfo, 64)
var file_byteplus_retail_proto_goTypes = []interface{}{
	(*Status)(nil),                        // 0: bytedance.byteplus.retail.Status
	(*Metadata)(nil),                      // 1: bytedance.byteplus.retail.Metadata
	(*Operation)(nil),                     // 2: bytedance.byteplus.retail.Operation
	(*OperationResponse)(nil),             // 3: bytedance.byteplus.retail.OperationResponse
	(*GetOperationRequest)(nil),           // 4: bytedance.byteplus.retail.GetOperationRequest
	(*ListOperationsRequest)(nil),         // 5: bytedance.byteplus.retail.ListOperationsRequest
	(*ListOperationsResponse)(nil),        // 6: bytedance.byteplus.retail.ListOperationsResponse
	(*User)(nil),                          // 7: bytedance.byteplus.retail.User
	(*WriteUsersRequest)(nil),             // 8: bytedance.byteplus.retail.WriteUsersRequest
	(*UserError)(nil),                     // 9: bytedance.byteplus.retail.UserError
	(*WriteUsersResponse)(nil),            // 10: bytedance.byteplus.retail.WriteUsersResponse
	(*UsersInlineSource)(nil),             // 11: bytedance.byteplus.retail.UsersInlineSource
	(*UsersInputConfig)(nil),              // 12: bytedance.byteplus.retail.UsersInputConfig
	(*DateConfig)(nil),                    // 13: bytedance.byteplus.retail.DateConfig
	(*ImportErrorsConfig)(nil),            // 14: bytedance.byteplus.retail.ImportErrorsConfig
	(*ImportUsersRequest)(nil),            // 15: bytedance.byteplus.retail.ImportUsersRequest
	(*ImportUsersResponse)(nil),           // 16: bytedance.byteplus.retail.ImportUsersResponse
	(*Product)(nil),                       // 17: bytedance.byteplus.retail.Product
	(*WriteProductsRequest)(nil),          // 18: bytedance.byteplus.retail.WriteProductsRequest
	(*ProductError)(nil),                  // 19: bytedance.byteplus.retail.ProductError
	(*WriteProductsResponse)(nil),         // 20: bytedance.byteplus.retail.WriteProductsResponse
	(*ProductsInlineSource)(nil),          // 21: bytedance.byteplus.retail.ProductsInlineSource
	(*ProductsInputConfig)(nil),           // 22: bytedance.byteplus.retail.ProductsInputConfig
	(*ImportProductsRequest)(nil),         // 23: bytedance.byteplus.retail.ImportProductsRequest
	(*ImportProductsResponse)(nil),        // 24: bytedance.byteplus.retail.ImportProductsResponse
	(*UserEvent)(nil),                     // 25: bytedance.byteplus.retail.UserEvent
	(*WriteUserEventsRequest)(nil),        // 26: bytedance.byteplus.retail.WriteUserEventsRequest
	(*UserEventError)(nil),                // 27: bytedance.byteplus.retail.UserEventError
	(*WriteUserEventsResponse)(nil),       // 28: bytedance.byteplus.retail.WriteUserEventsResponse
	(*UserEventsInlineSource)(nil),        // 29: bytedance.byteplus.retail.UserEventsInlineSource
	(*UserEventsInputConfig)(nil),         // 30: bytedance.byteplus.retail.UserEventsInputConfig
	(*ImportUserEventsRequest)(nil),       // 31: bytedance.byteplus.retail.ImportUserEventsRequest
	(*ImportUserEventsResponse)(nil),      // 32: bytedance.byteplus.retail.ImportUserEventsResponse
	(*PredictRequest)(nil),                // 33: bytedance.byteplus.retail.PredictRequest
	(*PredictResult)(nil),                 // 34: bytedance.byteplus.retail.PredictResult
	(*PredictResponse)(nil),               // 35: bytedance.byteplus.retail.PredictResponse
	(*AckServerImpressionsRequest)(nil),   // 36: bytedance.byteplus.retail.AckServerImpressionsRequest
	(*AckServerImpressionsResponse)(nil),  // 37: bytedance.byteplus.retail.AckServerImpressionsResponse
	(*User_Location)(nil),                 // 38: bytedance.byteplus.retail.User.Location
	nil,                                   // 39: bytedance.byteplus.retail.User.ExtraEntry
	nil,                                   // 40: bytedance.byteplus.retail.WriteUsersRequest.ExtraEntry
	nil,                                   // 41: bytedance.byteplus.retail.ImportUsersRequest.ExtraEntry
	(*Product_Category)(nil),              // 42: bytedance.byteplus.retail.Product.Category
	(*Product_Brand)(nil),                 // 43: bytedance.byteplus.retail.Product.Brand
	(*Product_Price)(nil),                 // 44: bytedance.byteplus.retail.Product.Price
	(*Product_Display)(nil),               // 45: bytedance.byteplus.retail.Product.Display
	(*Product_ProductSpec)(nil),           // 46: bytedance.byteplus.retail.Product.ProductSpec
	(*Product_Seller)(nil),                // 47: bytedance.byteplus.retail.Product.Seller
	nil,                                   // 48: bytedance.byteplus.retail.Product.ExtraEntry
	(*Product_Category_CategoryNode)(nil), // 49: bytedance.byteplus.retail.Product.Category.CategoryNode
	nil,                                   // 50: bytedance.byteplus.retail.WriteProductsRequest.ExtraEntry
	nil,                                   // 51: bytedance.byteplus.retail.ImportProductsRequest.ExtraEntry
	(*UserEvent_Scene)(nil),               // 52: bytedance.byteplus.retail.UserEvent.Scene
	(*UserEvent_Device)(nil),              // 53: bytedance.byteplus.retail.UserEvent.Device
	(*UserEvent_Context)(nil),             // 54: bytedance.byteplus.retail.UserEvent.Context
	nil,                                   // 55: bytedance.byteplus.retail.UserEvent.ExtraEntry
	nil,                                   // 56: bytedance.byteplus.retail.WriteUserEventsRequest.ExtraEntry
	nil,                                   // 57: bytedance.byteplus.retail.ImportUserEventsRequest.ExtraEntry
	(*PredictRequest_Context)(nil),        // 58: bytedance.byteplus.retail.PredictRequest.Context
	nil,                                   // 59: bytedance.byteplus.retail.PredictRequest.ExtraEntry
	(*PredictResult_ResponseProduct)(nil), // 60: bytedance.byteplus.retail.PredictResult.ResponseProduct
	nil,                                   // 61: bytedance.byteplus.retail.PredictResult.ExtraEntry
	nil,                                   // 62: bytedance.byteplus.retail.PredictResult.ResponseProduct.ExtraEntry
	(*AckServerImpressionsRequest_AlteredProduct)(nil), // 63: bytedance.byteplus.retail.AckServerImpressionsRequest.AlteredProduct
	(*anypb.Any)(nil), // 64: google.protobuf.Any
}
var file_byteplus_retail_proto_depIdxs = []int32{
	1,  // 0: bytedance.byteplus.retail.Operation.metadata:type_name -> bytedance.byteplus.retail.Metadata
	64, // 1: bytedance.byteplus.retail.Operation.response:type_name -> google.protobuf.Any
	0,  // 2: bytedance.byteplus.retail.OperationResponse.status:type_name -> bytedance.byteplus.retail.Status
	2,  // 3: bytedance.byteplus.retail.OperationResponse.operation:type_name -> bytedance.byteplus.retail.Operation
	0,  // 4: bytedance.byteplus.retail.ListOperationsResponse.status:type_name -> bytedance.byteplus.retail.Status
	2,  // 5: bytedance.byteplus.retail.ListOperationsResponse.operations:type_name -> bytedance.byteplus.retail.Operation
	38, // 6: bytedance.byteplus.retail.User.location:type_name -> bytedance.byteplus.retail.User.Location
	39, // 7: bytedance.byteplus.retail.User.extra:type_name -> bytedance.byteplus.retail.User.ExtraEntry
	7,  // 8: bytedance.byteplus.retail.WriteUsersRequest.users:type_name -> bytedance.byteplus.retail.User
	40, // 9: bytedance.byteplus.retail.WriteUsersRequest.extra:type_name -> bytedance.byteplus.retail.WriteUsersRequest.ExtraEntry
	7,  // 10: bytedance.byteplus.retail.UserError.user:type_name -> bytedance.byteplus.retail.User
	0,  // 11: bytedance.byteplus.retail.WriteUsersResponse.status:type_name -> bytedance.byteplus.retail.Status
	9,  // 12: bytedance.byteplus.retail.WriteUsersResponse.errors:type_name -> bytedance.byteplus.retail.UserError
	7,  // 13: bytedance.byteplus.retail.UsersInlineSource.users:type_name -> bytedance.byteplus.retail.User
	11, // 14: bytedance.byteplus.retail.UsersInputConfig.users_inline_source:type_name -> bytedance.byteplus.retail.UsersInlineSource
	12, // 15: bytedance.byteplus.retail.ImportUsersRequest.input_config:type_name -> bytedance.byteplus.retail.UsersInputConfig
	13, // 16: bytedance.byteplus.retail.ImportUsersRequest.date_config:type_name -> bytedance.byteplus.retail.DateConfig
	14, // 17: bytedance.byteplus.retail.ImportUsersRequest.errors_config:type_name -> bytedance.byteplus.retail.ImportErrorsConfig
	41, // 18: bytedance.byteplus.retail.ImportUsersRequest.extra:type_name -> bytedance.byteplus.retail.ImportUsersRequest.ExtraEntry
	0,  // 19: bytedance.byteplus.retail.ImportUsersResponse.status:type_name -> bytedance.byteplus.retail.Status
	9,  // 20: bytedance.byteplus.retail.ImportUsersResponse.error_samples:type_name -> bytedance.byteplus.retail.UserError
	42, // 21: bytedance.byteplus.retail.Product.categories:type_name -> bytedance.byteplus.retail.Product.Category
	43, // 22: bytedance.byteplus.retail.Product.brands:type_name -> bytedance.byteplus.retail.Product.Brand
	44, // 23: bytedance.byteplus.retail.Product.price:type_name -> bytedance.byteplus.retail.Product.Price
	45, // 24: bytedance.byteplus.retail.Product.display:type_name -> bytedance.byteplus.retail.Product.Display
	46, // 25: bytedance.byteplus.retail.Product.product_spec:type_name -> bytedance.byteplus.retail.Product.ProductSpec
	47, // 26: bytedance.byteplus.retail.Product.seller:type_name -> bytedance.byteplus.retail.Product.Seller
	48, // 27: bytedance.byteplus.retail.Product.extra:type_name -> bytedance.byteplus.retail.Product.ExtraEntry
	17, // 28: bytedance.byteplus.retail.WriteProductsRequest.products:type_name -> bytedance.byteplus.retail.Product
	50, // 29: bytedance.byteplus.retail.WriteProductsRequest.extra:type_name -> bytedance.byteplus.retail.WriteProductsRequest.ExtraEntry
	17, // 30: bytedance.byteplus.retail.ProductError.product:type_name -> bytedance.byteplus.retail.Product
	0,  // 31: bytedance.byteplus.retail.WriteProductsResponse.status:type_name -> bytedance.byteplus.retail.Status
	19, // 32: bytedance.byteplus.retail.WriteProductsResponse.errors:type_name -> bytedance.byteplus.retail.ProductError
	17, // 33: bytedance.byteplus.retail.ProductsInlineSource.products:type_name -> bytedance.byteplus.retail.Product
	21, // 34: bytedance.byteplus.retail.ProductsInputConfig.products_inline_source:type_name -> bytedance.byteplus.retail.ProductsInlineSource
	22, // 35: bytedance.byteplus.retail.ImportProductsRequest.input_config:type_name -> bytedance.byteplus.retail.ProductsInputConfig
	13, // 36: bytedance.byteplus.retail.ImportProductsRequest.date_config:type_name -> bytedance.byteplus.retail.DateConfig
	14, // 37: bytedance.byteplus.retail.ImportProductsRequest.errors_config:type_name -> bytedance.byteplus.retail.ImportErrorsConfig
	51, // 38: bytedance.byteplus.retail.ImportProductsRequest.extra:type_name -> bytedance.byteplus.retail.ImportProductsRequest.ExtraEntry
	0,  // 39: bytedance.byteplus.retail.ImportProductsResponse.status:type_name -> bytedance.byteplus.retail.Status
	19, // 40: bytedance.byteplus.retail.ImportProductsResponse.error_samples:type_name -> bytedance.byteplus.retail.ProductError
	52, // 41: bytedance.byteplus.retail.UserEvent.scene:type_name -> bytedance.byteplus.retail.UserEvent.Scene
	53, // 42: bytedance.byteplus.retail.UserEvent.device:type_name -> bytedance.byteplus.retail.UserEvent.Device
	54, // 43: bytedance.byteplus.retail.UserEvent.context:type_name -> bytedance.byteplus.retail.UserEvent.Context
	55, // 44: bytedance.byteplus.retail.UserEvent.extra:type_name -> bytedance.byteplus.retail.UserEvent.ExtraEntry
	25, // 45: bytedance.byteplus.retail.WriteUserEventsRequest.user_events:type_name -> bytedance.byteplus.retail.UserEvent
	56, // 46: bytedance.byteplus.retail.WriteUserEventsRequest.extra:type_name -> bytedance.byteplus.retail.WriteUserEventsRequest.ExtraEntry
	25, // 47: bytedance.byteplus.retail.UserEventError.user_event:type_name -> bytedance.byteplus.retail.UserEvent
	0,  // 48: bytedance.byteplus.retail.WriteUserEventsResponse.status:type_name -> bytedance.byteplus.retail.Status
	27, // 49: bytedance.byteplus.retail.WriteUserEventsResponse.errors:type_name -> bytedance.byteplus.retail.UserEventError
	25, // 50: bytedance.byteplus.retail.UserEventsInlineSource.user_events:type_name -> bytedance.byteplus.retail.UserEvent
	29, // 51: bytedance.byteplus.retail.UserEventsInputConfig.user_events_inline_source:type_name -> bytedance.byteplus.retail.UserEventsInlineSource
	30, // 52: bytedance.byteplus.retail.ImportUserEventsRequest.input_config:type_name -> bytedance.byteplus.retail.UserEventsInputConfig
	13, // 53: bytedance.byteplus.retail.ImportUserEventsRequest.date_config:type_name -> bytedance.byteplus.retail.DateConfig
	14, // 54: bytedance.byteplus.retail.ImportUserEventsRequest.errors_config:type_name -> bytedance.byteplus.retail.ImportErrorsConfig
	57, // 55: bytedance.byteplus.retail.ImportUserEventsRequest.extra:type_name -> bytedance.byteplus.retail.ImportUserEventsRequest.ExtraEntry
	0,  // 56: bytedance.byteplus.retail.ImportUserEventsResponse.status:type_name -> bytedance.byteplus.retail.Status
	27, // 57: bytedance.byteplus.retail.ImportUserEventsResponse.error_samples:type_name -> bytedance.byteplus.retail.UserEventError
	52, // 58: bytedance.byteplus.retail.PredictRequest.scene:type_name -> bytedance.byteplus.retail.UserEvent.Scene
	58, // 59: bytedance.byteplus.retail.PredictRequest.context:type_name -> bytedance.byteplus.retail.PredictRequest.Context
	59, // 60: bytedance.byteplus.retail.PredictRequest.extra:type_name -> bytedance.byteplus.retail.PredictRequest.ExtraEntry
	60, // 61: bytedance.byteplus.retail.PredictResult.response_products:type_name -> bytedance.byteplus.retail.PredictResult.ResponseProduct
	61, // 62: bytedance.byteplus.retail.PredictResult.extra:type_name -> bytedance.byteplus.retail.PredictResult.ExtraEntry
	0,  // 63: bytedance.byteplus.retail.PredictResponse.status:type_name -> bytedance.byteplus.retail.Status
	34, // 64: bytedance.byteplus.retail.PredictResponse.value:type_name -> bytedance.byteplus.retail.PredictResult
	52, // 65: bytedance.byteplus.retail.AckServerImpressionsRequest.scene:type_name -> bytedance.byteplus.retail.UserEvent.Scene
	63, // 66: bytedance.byteplus.retail.AckServerImpressionsRequest.altered_products:type_name -> bytedance.byteplus.retail.AckServerImpressionsRequest.AlteredProduct
	0,  // 67: bytedance.byteplus.retail.AckServerImpressionsResponse.status:type_name -> bytedance.byteplus.retail.Status
	49, // 68: bytedance.byteplus.retail.Product.Category.category_nodes:type_name -> bytedance.byteplus.retail.Product.Category.CategoryNode
	17, // 69: bytedance.byteplus.retail.PredictRequest.Context.root_product:type_name -> bytedance.byteplus.retail.Product
	53, // 70: bytedance.byteplus.retail.PredictRequest.Context.device:type_name -> bytedance.byteplus.retail.UserEvent.Device
	62, // 71: bytedance.byteplus.retail.PredictResult.ResponseProduct.extra:type_name -> bytedance.byteplus.retail.PredictResult.ResponseProduct.ExtraEntry
	8,  // 72: bytedance.byteplus.retail.BytePlusRetailService.WriteUsers:input_type -> bytedance.byteplus.retail.WriteUsersRequest
	15, // 73: bytedance.byteplus.retail.BytePlusRetailService.ImportUsers:input_type -> bytedance.byteplus.retail.ImportUsersRequest
	18, // 74: bytedance.byteplus.retail.BytePlusRetailService.WriteProducts:input_type -> bytedance.byteplus.retail.WriteProductsRequest
	23, // 75: bytedance.byteplus.retail.BytePlusRetailService.ImportProducts:input_type -> bytedance.byteplus.retail.ImportProductsRequest
	26, // 76: bytedance.byteplus.retail.BytePlusRetailService.WriteUserEvents:input_type -> bytedance.byteplus.retail.WriteUserEventsRequest
	31, // 77: bytedance.byteplus.retail.BytePlusRetailService.ImportUserEvents:input_type -> bytedance.byteplus.retail.ImportUserEventsRequest
	4,  // 78: bytedance.byteplus.retail.BytePlusRetailService.GetOperation:input_type -> bytedance.byteplus.retail.GetOperationRequest
	5,  // 79: bytedance.byteplus.retail.BytePlusRetailService.ListOperations:input_type -> bytedance.byteplus.retail.ListOperationsRequest
	33, // 80: bytedance.byteplus.retail.BytePlusRetailService.Predict:input_type -> bytedance.byteplus.retail.PredictRequest
	36, // 81: bytedance.byteplus.retail.BytePlusRetailService.AckServerImpressions:input_type -> bytedance.byteplus.retail.AckServerImpressionsRequest
	10, // 82: bytedance.byteplus.retail.BytePlusRetailService.WriteUsers:output_type -> bytedance.byteplus.retail.WriteUsersResponse
	3,  // 83: bytedance.byteplus.retail.BytePlusRetailService.ImportUsers:output_type -> bytedance.byteplus.retail.OperationResponse
	20, // 84: bytedance.byteplus.retail.BytePlusRetailService.WriteProducts:output_type -> bytedance.byteplus.retail.WriteProductsResponse
	3,  // 85: bytedance.byteplus.retail.BytePlusRetailService.ImportProducts:output_type -> bytedance.byteplus.retail.OperationResponse
	28, // 86: bytedance.byteplus.retail.BytePlusRetailService.WriteUserEvents:output_type -> bytedance.byteplus.retail.WriteUserEventsResponse
	3,  // 87: bytedance.byteplus.retail.BytePlusRetailService.ImportUserEvents:output_type -> bytedance.byteplus.retail.OperationResponse
	3,  // 88: bytedance.byteplus.retail.BytePlusRetailService.GetOperation:output_type -> bytedance.byteplus.retail.OperationResponse
	6,  // 89: bytedance.byteplus.retail.BytePlusRetailService.ListOperations:output_type -> bytedance.byteplus.retail.ListOperationsResponse
	35, // 90: bytedance.byteplus.retail.BytePlusRetailService.Predict:output_type -> bytedance.byteplus.retail.PredictResponse
	37, // 91: bytedance.byteplus.retail.BytePlusRetailService.AckServerImpressions:output_type -> bytedance.byteplus.retail.AckServerImpressionsResponse
...
func file_byteplus_retail_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_byteplus_retail_proto_msgTypes[32].Exporter = func(v interface{}, i int) interface{} {
		...
		file_byteplus_retail_proto_msgTypes[33].Exporter = func(v interface{}, i int) interface{} {
		...
		file_byteplus_retail_proto_msgTypes[34].Exporter = func(v interface{}, i int) interface{} {
		...
		file_byteplus_retail_proto_msgTypes[43].Exporter = func(v interface{}, i int) interface{} {
		...
		file_byteplus_retail_proto_msgTypes[44].Exporter = func(v interface{}, i int) interface{} {
		...
		file_byteplus_retail_proto_msgTypes[49].Exporter = func(v interface{}, i int) interface{} {
		...
		file_byteplus_retail_proto_msgTypes[52].Exporter = func(v interface{}, i int) interface{} {
		...
		file_byteplus_retail_proto_msgTypes[54].Exporter = func(v interface{}, i int) interface{} {
		...
		file_byteplus_retail_proto_msgTypes[58].Exporter = func(v interface{}, i int) interface{} {
		...
		file_byteplus_retail_proto_msgTypes[60].Exporter = func(v interface{}, i int) interface{} {
		...
		file_byteplus_retail_proto_msgTypes[63].Exporter = func(v interface{}, i int) interface{} {
	...
	file_byteplus_retail_proto_msgTypes[12].OneofWrappers = []interface{}{
		(*UsersInputConfig_UsersInlineSource)(nil),
	}
	file_byteplus_retail_proto_msgTypes[14].OneofWrappers = []interface{}{
		(*ImportErrorsConfig_EmptyDestination)(nil),
	}
	file_byteplus_retail_proto_msgTypes[22].OneofWrappers = []interface{}{
		(*ProductsInputConfig_ProductsInlineSource)(nil),
	}
	file_byteplus_retail_proto_msgTypes[30].OneofWrappers = []interface{}{
