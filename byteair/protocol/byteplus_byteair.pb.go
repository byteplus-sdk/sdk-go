...
var file_byteplus_byteair_proto_rawDesc = []byte{
	...
	0x72, 0x2e, 0x50, 0x72, 0x65, 0x64, 0x69, 0x63, 0x74, 0x55, 0x73, 0x65, 0x72, 0x2e, 0x45, 0x78,
	...
	0x64, 0x61, 0x6e, 0x63, 0x65, 0x2e, 0x62, 0x79, 0x74, 0x65, 0x70, 0x6c, 0x75, 0x73, 0x2e, 0x62,
	0x79, 0x74, 0x65, 0x61, 0x69, 0x72, 0x2e, 0x50, 0x72, 0x65, 0x64, 0x69, 0x63, 0x74, 0x43, 0x6f,
	...
	0x02, 0x32, 0x83, 0x03, 0x0a, 0x16, 0x42, 0x79, 0x74, 0x65, 0x70, 0x6c, 0x75, 0x73, 0x47, 0x65,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x62, 0x0a, 0x07,
	0x50, 0x72, 0x65, 0x64, 0x69, 0x63, 0x74, 0x12, 0x2a, 0x2e, 0x62, 0x79, 0x74, 0x65, 0x64, 0x61,
	0x6e, 0x63, 0x65, 0x2e, 0x62, 0x79, 0x74, 0x65, 0x70, 0x6c, 0x75, 0x73, 0x2e, 0x62, 0x79, 0x74,
	0x65, 0x61, 0x69, 0x72, 0x2e, 0x50, 0x72, 0x65, 0x64, 0x69, 0x63, 0x74, 0x52, 0x65, 0x71, 0x75,
	...
	0x64, 0x61, 0x6e, 0x63, 0x65, 0x2e, 0x62, 0x79, 0x74, 0x65, 0x70, 0x6c, 0x75, 0x73, 0x2e, 0x62,
	0x79, 0x74, 0x65, 0x61, 0x69, 0x72, 0x2e, 0x43, 0x61, 0x6c, 0x6c, 0x62, 0x61, 0x63, 0x6b, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x50, 0x0a, 0x1d, 0x62, 0x79, 0x74, 0x65, 0x70,
	0x6c, 0x75, 0x73, 0x2e, 0x73, 0x64, 0x6b, 0x2e, 0x62, 0x79, 0x74, 0x65, 0x61, 0x69, 0x72, 0x2e,
	...
	0x6b, 0x2f, 0x73, 0x64, 0x6b, 0x2d, 0x67, 0x6f, 0x2f, 0x62, 0x79, 0x74, 0x65, 0x61, 0x69, 0x72,
...
var file_byteplus_byteair_proto_msgTypes = make([]protoimpl.MessageInfo, 33)
var file_byteplus_byteair_proto_goTypes = []interface{}{
	...
	(*PredictResult)(nil),              // 16: bytedance.byteplus.byteair.PredictResult
	(*PredictItem)(nil),                // 17: bytedance.byteplus.byteair.PredictItem
	(*CallbackRequest)(nil),            // 18: bytedance.byteplus.byteair.CallbackRequest
	(*CallbackItem)(nil),               // 19: bytedance.byteplus.byteair.CallbackItem
	(*CallbackContext)(nil),            // 20: bytedance.byteplus.byteair.CallbackContext
	...
	nil,                                // 27: bytedance.byteplus.byteair.SearchInfo.FiltersEntry
	nil,                                // 28: bytedance.byteplus.byteair.SearchInfo.FilterOutEntry
	nil,                                // 29: bytedance.byteplus.byteair.PredictParentItem.ExtraEntry
	nil,                                // 30: bytedance.byteplus.byteair.PredictResult.ExtraEntry
	nil,                                // 31: bytedance.byteplus.byteair.PredictItem.ExtraEntry
	nil,                                // 32: bytedance.byteplus.byteair.CallbackRequest.ExtraEntry
	nil,                                // 33: bytedance.byteplus.byteair.CallbackContext.ExtraEntry
...
var file_byteplus_byteair_proto_depIdxs = []int32{
	34, // 0: bytedance.byteplus.byteair.WriteResponse.status:type_name -> bytedance.byteplus.common.Status
	1,  // 1: bytedance.byteplus.byteair.WriteResponse.errors:type_name -> bytedance.byteplus.byteair.DataError
	34, // 2: bytedance.byteplus.byteair.ImportResponse.status:type_name -> bytedance.byteplus.common.Status
	...
	6,  // 11: bytedance.byteplus.byteair.PredictUser.device:type_name -> bytedance.byteplus.byteair.PredictDevice
	22, // 12: bytedance.byteplus.byteair.PredictUser.extra:type_name -> bytedance.byteplus.byteair.PredictUser.ExtraEntry
	23, // 13: bytedance.byteplus.byteair.PredictContext.extra:type_name -> bytedance.byteplus.byteair.PredictContext.ExtraEntry
	24, // 14: bytedance.byteplus.byteair.PredictCandidateItem.extra:type_name -> bytedance.byteplus.byteair.PredictCandidateItem.ExtraEntry
	25, // 15: bytedance.byteplus.byteair.PredictExtra.extra:type_name -> bytedance.byteplus.byteair.PredictExtra.ExtraEntry
	26, // 16: bytedance.byteplus.byteair.PredictRelatedItem.extra:type_name -> bytedance.byteplus.byteair.PredictRelatedItem.ExtraEntry
	27, // 17: bytedance.byteplus.byteair.SearchInfo.filters:type_name -> bytedance.byteplus.byteair.SearchInfo.FiltersEntry
	28, // 18: bytedance.byteplus.byteair.SearchInfo.filterOut:type_name -> bytedance.byteplus.byteair.SearchInfo.FilterOutEntry
	13, // 19: bytedance.byteplus.byteair.SearchInfo.goodsList:type_name -> bytedance.byteplus.byteair.SearchGoods
	29, // 20: bytedance.byteplus.byteair.PredictParentItem.extra:type_name -> bytedance.byteplus.byteair.PredictParentItem.ExtraEntry
	16, // 21: bytedance.byteplus.byteair.PredictResponse.value:type_name -> bytedance.byteplus.byteair.PredictResult
	17, // 22: bytedance.byteplus.byteair.PredictResult.items:type_name -> bytedance.byteplus.byteair.PredictItem
	30, // 23: bytedance.byteplus.byteair.PredictResult.extra:type_name -> bytedance.byteplus.byteair.PredictResult.ExtraEntry
	31, // 24: bytedance.byteplus.byteair.PredictItem.extra:type_name -> bytedance.byteplus.byteair.PredictItem.ExtraEntry
	19, // 25: bytedance.byteplus.byteair.CallbackRequest.items:type_name -> bytedance.byteplus.byteair.CallbackItem
	20, // 26: bytedance.byteplus.byteair.CallbackRequest.context:type_name -> bytedance.byteplus.byteair.CallbackContext
	32, // 27: bytedance.byteplus.byteair.CallbackRequest.extra:type_name -> bytedance.byteplus.byteair.CallbackRequest.ExtraEntry
	0,  // 28: bytedance.byteplus.byteair.CallbackContext.req_type:type_name -> bytedance.byteplus.byteair.CallbackReqType
	33, // 29: bytedance.byteplus.byteair.CallbackContext.extra:type_name -> bytedance.byteplus.byteair.CallbackContext.ExtraEntry
	12, // 30: bytedance.byteplus.byteair.SearchInfo.FiltersEntry.value:type_name -> bytedance.byteplus.byteair.StringArray
	12, // 31: bytedance.byteplus.byteair.SearchInfo.FilterOutEntry.value:type_name -> bytedance.byteplus.byteair.StringArray
	35, // 32: bytedance.byteplus.byteair.ByteplusGeneralService.WriteData:input_type -> google.protobuf.Any
	35, // 33: bytedance.byteplus.byteair.ByteplusGeneralService.ImportData:input_type -> google.protobuf.Any
	4,  // 34: bytedance.byteplus.byteair.ByteplusGeneralService.Predict:input_type -> bytedance.byteplus.byteair.PredictRequest
	18, // 35: bytedance.byteplus.byteair.ByteplusGeneralService.Callback:input_type -> bytedance.byteplus.byteair.CallbackRequest
	2,  // 36: bytedance.byteplus.byteair.ByteplusGeneralService.WriteData:output_type -> bytedance.byteplus.byteair.WriteResponse
	36, // 37: bytedance.byteplus.byteair.ByteplusGeneralService.ImportData:output_type -> bytedance.byteplus.common.OperationResponse
	15, // 38: bytedance.byteplus.byteair.ByteplusGeneralService.Predict:output_type -> bytedance.byteplus.byteair.PredictResponse
	21, // 39: bytedance.byteplus.byteair.ByteplusGeneralService.Callback:output_type -> bytedance.byteplus.byteair.CallbackResponse
